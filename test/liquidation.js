...
describe("Liquidation test for question 3", function () {
  ...
  it("TEST Liquidation 8300 USDC", async function (input = "8300") {
  ...
  it("TEST Liquidation 8600 USDC", async function (input = "8600") {
    console.log("\nLiquidation " + input + " USDC")
    await network.provider.request({
      method: "hardhat_reset",
      params: [{
  ...
  it("TEST Liquidation 8900 USDC", async function (input = "8900") {
    console.log("\nLiquidation " +input+" USDC")
    await network.provider.request({
      method: "hardhat_reset",
      params: [{
  ...
  it("TEST Liquidation 9300 USDC", async function (input = "9300") {
    console.log("\nLiquidation " + input + " USDC")
    await network.provider.request({
      method: "hardhat_reset",
      params: [{
